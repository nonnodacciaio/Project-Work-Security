package com.generationitaly.incrediblestyle.security;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Autowired
    public SecurityConfig(PasswordEncoder passwordEncoder, AuthService authService) {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable() // Andate a vedere cos'è il csrf, in poche parole, la disabilito se mi serve
                ...
                .authorizeRequests()
                .antMatchers("/", "home.html", "styleGestionale.css", "mainGestionale.js", "/signup.html", "/signup",
                        "/login", "/fail.html",
                        "/forbidden.html", "/assets/**")
                .permitAll()
                ...
                .clearAuthentication(true).logoutSuccessUrl("/home.html");
    }

    @Bean
    // questo oggetto servirà a spring security per andare a cercare gli utenti da
    // un service
